...
(function($) {
    "use strict";
    var $accordion = $('#accordion1 .panel a');
    $accordion.click(function() {
        $accordion.removeClass('selected');
        $(this).addClass('selected');
    });
...
(function($) {
    "use strict";
    var $accordion = $('#accordion2 .panel a');
    $accordion.click(function() {
        $accordion.removeClass('selected');
        $(this).addClass('selected');
    });
    $('#accordion2 .panel a').on('click', function(e) {
        if ($(this).parents('.panel').children('.panel-collapse').hasClass('in')) {
            $accordion.removeClass('selected');
        }
    });
...
$(document).ready(function() {
    ...
    $(".cowlnext").click(function() {
        owl1.trigger('owl.next');
    });
    $(".cowlprev").click(function() {
